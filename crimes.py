...
# 2. Pull crime counts PER BLOCK-GROUP AND CRIME TYPE with pagination
...
# Use defaultdict to track both zip crime totals and crime type breakdown
...
for zipcode, total_crimes in zip_total_counts.items():
    ...
    # Get crime types for this zipcode, sorted by count
