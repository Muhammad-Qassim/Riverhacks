    ...
    <section className="flex relative flex-col mt-36 max-w-full w-[868px] max-md:mt-10">
      ...
      <div className="flex flex-col mt-12 w-full max-md:mt-10 max-md:max-w-full">
        <div className="flex overflow-hidden flex-wrap gap-16 items-end px-3 py-2.5 w-full rounded-2xl border border-solid bg-stone-100 border-zinc-900 border-opacity-20 shadow-[0px_18px_29px_rgba(0,0,0,0.04)] max-md:max-w-full max-sm:mx-auto max-sm:w-4/5 max-sm:max-w-[80%]">
          <div className="overflow-hidden grow shrink gap-2.5 self-stretch px-2.5 text-2xl text-black rounded-lg min-h-[26px] min-w-60 w-[821px] max-md:max-w-full">
            <span style={{ backgroundColor: "rgb(243, 243, 243)" }}>
              Enter your budget and what you want nearby…
            </span>
          </div>
          ...
          <button className="flex grow shrink gap-2.5 items-center p-1 w-[30px]">
            <img
              ...
              className="object-contain self-stretch my-auto aspect-square w-[31px]"
              alt="Search Icon"
            />
          </button>
        </div>
        <div className="flex flex-wrap gap-3 items-center self-center mt-10 text-sm leading-loose text-center text-zinc-900 max-md:max-w-full">
          <KeywordButton
